...
public struct AffineMatrix : Equatable, CustomStringConvertible {
    ...
    @inlinable
    public init() {
        self.init(diagonal: Vector3f(repeating: 1))
    }
    ...
    public var inverse : AffineMatrix {
        // TODO: SIMD optimise with reference: https://lxjk.github.io/2017/09/03/Fast-4x4-Matrix-Inverse-with-SSE-SIMD-Explained.html
    ...
    public var inverseNoScale : AffineMatrix {
        ...
        let rotation = Matrix3x3f(self)
        let scaleRotationInverse = rotation.transpose
...
extension AffineMatrix {
    ...
    public static let identity = AffineMatrix(diagonal: Vector3f(repeating: 1.0))
    ...
    public static func scaleRotateTranslate(scale: Vector3f,
        ...
        var r0 = Vector4f(repeating: 0)
        var r1 = Vector4f(repeating: 0)
        var r2 = Vector4f(repeating: 0)
...
extension AffineMatrix {
    ...
    public var right : Vector3f {
        get {
            return Vector3f(r0.x, r1.x, r2.x)
        }
        set {
    ...
    public var up : Vector3f {
        get {
            return Vector3f(r0.y, r1.y, r2.y)
        }
        set {
    ...
    public var forward : Vector3f {
        get {
            return Vector3f(r0.z, r1.z, r2.z)
        }
        set {
