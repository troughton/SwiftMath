...
extension Rect {
    ...
    public nonmutating func applying(matrix: Matrix4x4f) -> Rect {
        let bl : Vector2f = (matrix * Vector4f(bottomLeft, Vector2f(0, 1))).xy
        let br : Vector2f = (matrix * Vector4f(bottomRight, Vector2f(0, 1))).xy
        let tl : Vector2f = (matrix * Vector4f(topLeft, Vector2f(0, 1))).xy
        let tr : Vector2f = (matrix * Vector4f(topRight, Vector2f(0, 1))).xy
